...
ALTER TABLE cluster_has_psm ADD CONSTRAINT cluster_has_psm_cluster_FK FOREIGN KEY (cluster_fk) REFERENCES spectrum_cluster (cluster_pk)
  ON DELETE CASCADE;

ALTER TABLE cluster_has_psm ADD CONSTRAINT cluster_has_psm_psm_FK FOREIGN KEY (psm_fk) REFERENCES psm (psm_pk)
  ON DELETE CASCADE;

ALTER TABLE cluster_has_spectrum ADD CONSTRAINT cluster_to_spec_spec_FK FOREIGN KEY (spectrum_fk) REFERENCES spectrum (spectrum_pk)
  ON DELETE CASCADE;

ALTER TABLE cluster_has_spectrum ADD CONSTRAINT cluster_to_spectrum_cluster_FK FOREIGN KEY (cluster_fk) REFERENCES spectrum_cluster (cluster_pk)
  ON DELETE CASCADE;

ALTER TABLE psm ADD CONSTRAINT psm_assay_FK FOREIGN KEY (assay_fk) REFERENCES assay (assay_pk)
  ON DELETE CASCADE;

ALTER TABLE psm ADD CONSTRAINT psm_spectrum_FK FOREIGN KEY (spectrum_fk) REFERENCES spectrum (spectrum_pk)
  ON DELETE CASCADE;

ALTER TABLE spectrum ADD CONSTRAINT spectrum_assay_FK FOREIGN KEY (assay_fk) REFERENCES assay (assay_pk)
  ON DELETE CASCADE;

CREATE SEQUENCE assay_pk_sequence
    START WITH 1;
-- NOCACHE AND ORDER OPTIONS ARE NOT SUPPORTED IN HSQLDB
-- NOCACHE ORDER
CREATE TRIGGER assay_assay_pk_TRG BEFORE INSERT ON assay
  REFERENCING NEW AS newrow
FOR EACH ROW
  WHEN (newrow.assay_pk IS NULL)
  SET newrow.assay_pk = assay_pk_sequence.NEXTVAL;


CREATE SEQUENCE psm_pk_sequence
    START WITH 1
    INCREMENT BY 1000;
-- NOCACHE AND ORDER OPTIONS ARE NOT SUPPORTED IN HSQLDB
-- NOCACHE ORDER;
CREATE TRIGGER psm_psm_pk_TRG BEFORE INSERT ON psm
  REFERENCING NEW AS newrow
FOR EACH ROW
  WHEN (newrow.psm_pk IS NULL)
  SET newrow.psm_pk = psm_pk_sequence.NEXTVAL;


CREATE SEQUENCE spectrum_pk_sequence
    START WITH 1
    INCREMENT BY 1000;
-- NOCACHE AND ORDER OPTIONS ARE NOT SUPPORTED IN HSQLDB
-- NOCACHE ORDER;
CREATE TRIGGER spectrum_spectrum_pk_TRG BEFORE INSERT ON spectrum
  REFERENCING NEW AS newrow
FOR EACH ROW
  WHEN (newrow.spectrum_pk IS NULL)
  SET newrow.spectrum_pk = spectrum_pk_sequence.NEXTVAL;


CREATE SEQUENCE cluster_pk_sequence
    START WITH 1;
-- NOCACHE AND ORDER OPTIONS ARE NOT SUPPORTED IN HSQLDB
-- NOCACHE ORDER;
CREATE TRIGGER spectrum_cluster_cluster_pk BEFORE INSERT ON spectrum_cluster
REFERENCING NEW AS newrow
FOR EACH ROW
  WHEN (newrow.cluster_pk IS NULL)
  SET newrow.cluster_pk = cluster_pk_sequence.NEXTVAL;
